...
export ROSLISP_PACKAGE_DIRECTORIES="`/Users/anna/Documents/TUM/Thesis/ba-bio-inspired-navigation-main/venv/bin/python -c \"$PYTHON_CODE_BUILD_ROSLISP_PACKAGE_DIRECTORIES\"`"
